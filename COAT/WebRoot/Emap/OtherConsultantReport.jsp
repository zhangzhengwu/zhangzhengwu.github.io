...
/*****************************************************Down click**********************************/
	$("#down").click(function(){ 
		if(downs!=null){
			window.location.href="<%=basePath%>/DownpartConsultantReportServlet?start_Date="+$("#start_date").val()+"&end_Date="+$("#end_date").val()+"&curretPage="+curPage+"&staffcode="+$("#staffcodes").val();
		}
		else{
	...
	function selects(){
				...
				success:function(data){
					...
					for(var i=0;i<dataRole[0].length;i++){
						html+="<tr id='select' title='"+i+"'><td>"+dataRole[0][i].recruiter+"</td><td>"+dataRole[0][i].staffcode+"</td><td>"+
