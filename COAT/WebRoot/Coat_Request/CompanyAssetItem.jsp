...
<html>
  ...
  function selects_last(pageNow){
			...
			data: {'method':'query','start_Date':$("#start_date").val(),'end_Date':$("#end_date").val(),
			...
			success:function(data){
				...
				if(dataRole[3]>0){
					...
					for(var i=0;i<dataRole[0].length;i++){
						html+="<tr id='select' title='"+i+"'><td align='center'>"+dataRole[0][i].itemcode+"</td><td  align='left'>"+
						dataRole[0][i].itemname+"</td><td align='center'>"+dataRole[0][i].itemnum+"</td><td align='center'>"
						+dataRole[0][i].remainnum+"</td>"+"<td align='center'>"+dataRole[0][i].creator+"</td><td align='center'>"+
						dataRole[0][i].createDate+"</td>" +"</td><td align='center'>"+dataRole[0][i].sfyx+"</td></tr>";
					}
				}
				else{
					$(".page_and_btn").hide();
...
<div class="cont-info" id="Medical">
	...
	<div class="info-table">
		<table id="jqajax">
			<thead id="title">
			<tr>
				<th class="width_10">Item Code</th>
				<th class="width_15">Item Name</th>
				<th class="width_10">Itemnum</th>
				<th class="width_10">Remainnum</th>
