	  ...
	  if($("#start_date").val()!="" && $("#end_date").val()!=""){
	   ...
	   $.ajax({
    		  ...
    		  data:{"method":"select","startDate":$("#start_date").val(),
	    		  "endDate":$("#end_date").val(),"staffcode":'${convoy_username}',"staffname":"",
	    		  "refno":$("#refno").val(),"status":$("#status").val(),"curretPage":pageNow},
	    	  beforeSend: function(){
	    			  parent.showLoad();
	    	  },
	    	  complete: function(){
    		  ...
    		  success:function(date){
    			  var dataRole=eval(date);
    				...
    				if(dataRole[0].photoSticker=="Y"){
    					...
    					//$("#photoPath").empty().append(""+dataRole[0].remark1);
					...
					if(dataRole[0].status=="Completed"){//Completed
	...
	<div class="info-form" id="pay_div"> 
		...
		<table id="pay_table">
			...
			<tr>
				...
				<td class="tagCont">
					...
					<label class="inline checkbox">
						<input type="checkbox"  name="paymentAmount" value="50"  class="paymentAmount"/>
						HKD 50.00
					</label>
					<label class="inline checkbox">
			...
			<tr>
				...
				<td class="tagCont">
					<input type="text" id="paymentDate" onClick="return Calendar('paymentDate')" value=""/>
				</td>
			</tr>
			<tr>
