...
<html>
  <head>
	...
	<script src="<%=basePath%>/css/lhgCommon.js" language="JavaScript"></script>
...
$.ajax({
	 ...
	 type: "post",
	 data: {"method":"selectListByType","noticetype":$("#type").val(),"pageNow":pagenows,
		"subject":$("#subject").val(),"company":$("#company").val(),"date1":$("#date1").val(),"date2":$("#date2").val(),"read":$("#read").val()},
	 beforeSend: function(){
		parent.showLoad();
	 },
	 complete: function(){
	 	...
	 	if(data==null || data == "[]"){
			...
			if(dataRole[3]>0){
				...
				for(var i=0;i<dataRole[0].length;i++){
					...
					+if_read +"</td><td align='center'><a href='javascript:void(0);' onclick='detail("+dataRole[0][i].id+")'>详细</a>/<a href='javascript:void(0);' onclick='del("+dataRole[0][i].id+")'>删除</a></td>";		 
				}
	 				$(".page_and_btn").show();
