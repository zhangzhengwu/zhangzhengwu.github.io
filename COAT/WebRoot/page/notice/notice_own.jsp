...
$.ajax({
	 ...
	 type: "post",
	 data: {"method":"queryByNoticeType_Own","noticetype":$("#type").val(),"pageNow":pagenows,
	 	...
	 	if(data==null || data == "[]"){
			...
			if(dataRole[3]>0){
				...
				for(var i=0;i<dataRole[0].length;i++){
					...
					+if_read +"</td><td align='center'><a href='javascript:void(0);' onclick='detail("+dataRole[0][i].id+")'>详细</a></td>";		 
				}
	 				$(".page_and_btn").show();
