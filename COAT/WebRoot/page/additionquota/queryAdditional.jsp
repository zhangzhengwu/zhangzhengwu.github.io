	...
	success:function(date){
	 var html="";
 			...
 			if(dataRole[3]>0){
				  ...
				  dataRole[0][i].upd_date+"</td><td align='center'><font size='+0'>"+sfyx+"</font></td><td align='center'>" +
				  "<c:if test='${roleObj.upd==1}'><a onclick='modify("+i+")'>"+"修改"+"</a></c:if></td></tr>";
				   }
				   	 $(".page_and_btn").show();
  	...
  	<div class="info-search">
  		<table>
  			...
  			<tr>
  				...
  				<td class="tagCont">
  					<input name="text" type="text" id="end_date" onClick="Calendar('end_date')"   readonly="readonly" /> 
...
/***********************************添加按钮***************************************************************/
$("#add").click(function (){ 
	var url = basepath + "page/additionquota/queryAdditional_info.jsp";
	addlhg(440,300,url);
});
function modify(index)
{
	var data = downs[index];
	var url = basepath + "page/additionquota/queryAdditional_modify.jsp";
