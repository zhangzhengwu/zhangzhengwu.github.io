...
<html>
  <head>
    ...
    <title>My JSP 'marketingpremium_modify.jsp' starting page</title>
	...
	<div class="form-table">
		<table class="col-4-table">
			<tr>
				...
				<td class="tagCont">
					<input type="text" name="" id="procode" disabled/>
				</td>
...
$(function(){
	...
	$('#clubprice').val(data.c_clubprice);
	$('#specialprice').val(data.specialprice);
	$('#unit').val(data.unit);
	$('#quantity').val(data.quantity);
	$('#remark').val(data.remark1);
