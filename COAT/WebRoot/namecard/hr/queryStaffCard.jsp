					...
					if(dataRole[3]>0){
						...
						for(var i=0;i<dataRole[0].length;i++){
							...
							if(dataRole[0][i].shzt =="S"){
								...
								Details="<a href='javascript:void(0);' onclick='modify("+i+")'>Detail</a> &nbsp; <a href='javascript:void(0);' onclick='del("+i+")'>Delete</a>";
								/**if(comptime(dataRole[0][i].urgentDate,GetDateStr("${SystemAcceTime}".substring(0,10).split("-"),-1)+" 12:00:00")==1 && parseFloat(("${SystemAcceTime}").substring(11,13))<12){
									Details="<a href='javascript:void(0);' onclick='modify("+i+")'>Detail</a> &nbsp; <a href='javascript:void(0);' onclick='del("+i+")'>Delete</a>";
								}else if(comptime(dataRole[0][i].urgentDate,"${SystemAcceTime}".substring(0,10)+" 12:00:00")==1 && parseFloat(("${SystemAcceTime}").substring(11,13))>=12){
									Details="<a href='javascript:void(0);' onclick='modify("+i+")'>Detail</a> &nbsp; <a href='javascript:void(0);' onclick='del("+i+")'>Delete</a>";
								}**/
							...
							+dataRole[0][i].profess_title_e +"</td><td align='center'>"+dataRole[0][i].profess_title_c +"</td><td align='center'>"+dataRole[0][i].quantity +"</td><td align='center'>"+dataRole[0][i].urgentDate+"</td>"+status+"</tr>";		 
						}
						html+="<tr  id='select'><td colspan='11'><span  style='color:red'><strong>Remark:&nbsp;&nbsp;1.These record can be “Delete” before 12:00 pm." +
...
/*****************************表单结束********************************/	
	...
	function del(obj){
		...
		if(confirm("Sure to Delete?")){
			$.ajax({
				...
				type:"post",
				data:{"staffcode":downs[obj].staff_code,"urgentDate":downs[obj].urgentDate,"table":"request_staff_convoy"},
				success:function(date){
					alert(date);
					$("#searchs").click();
				},error:function(){
  ...
  function modify(deom){
	...
	$("#EnglishPosition").append("<option value='"+ep+"'>"+ep+"</option>"); 
	...
	<div class="info-table">
		<table id="jqajax">
			...
			<tr>
				...
				<th class="width_">Position & Department in (Eng)</th>
				<th class="width_">Position & Department in (Chi)</th>
				<th class="width_">Professional Title (Eng)</th>
				<th class="width_">Professional Title (Chi)</th>
		...
		<div class="title-info">
			<table>
				...
				<tr>
					...
					<td class="tagCont">
						<label class="inline radio">
							<input type="radio" name="ET" value="Y" id="ET_0">YES
						</label>
						<label class="inline radio">
							<input type="radio" name="ET" value="N" id="ET_1">NO
						</label>
					</td>
					<td class="tagName">Urgent Case:</td>
					<td class="tagCont">
						<input name="urgent2" type="checkbox" id="urgent" title="1" value="N">
					</td>
				</tr>
				<tr>
					...
					<td class="tagCont">
						<input id="ChineseName_modify" name="ChineseNames" type="text" size="33" class="txt" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tagCont">
						<input id="ChineseStaffDepartmentText" name="ChineseStaffDepartmentTexts" type="text" size="33"  class="txt"/>
					</td>
				</tr>
				<tr>
					...
					<td class="tagCont">
						<input id="ChineseProfessionalTitle" name="ChineseProfessionalTitles" type="text" size="33"  class="txt"/>
					</td>
				</tr>
				<tr>
					...
					<td class="tagCont">
						<input id="ChineseAcademicTitle" name="ChineseAcademicTitles" type="text" size="33"  class="txt"/>
					</td>
				</tr>
				<tr>
					...
					<td class="tagCont">
						<input type="text" class="txt" name="chineseExternal" id="chineseExternal" size="33" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tagCont" colspan="3">
						<textarea name="remarks" id="remarks" cols="70" rows="5" style="width: 70%;"></textarea>
					</td>
				</tr>
				<tr>
