...
<div class="cont-info">
	<div class="info-title">
		<div class="title-info">
			<form action="AddDeptStaffRequestServlet" id="myform" method="post">
			<table>
				<tr>
				...
				<tr>
					...
					<td class="tagCont">
						...
						<label class="inline radio">
							<input name="ETs" type="radio" value="N"/>NO
						</label>
					</td>
				...
				<tr>
					...
					<td class="tagCont" colspan="3">
						<div id="upload" style="display: none;"> 
					        ...
					        <a style="display:none;text-decoration: none;" id="quitFujian" href="javascript:void(0);" onclick="javascript:$(this).hide();fileName='';$('#downs').empty();$('#upload_view').show();">Delete</a>
         				</div>
					</td>
				</tr>
				<tr>
