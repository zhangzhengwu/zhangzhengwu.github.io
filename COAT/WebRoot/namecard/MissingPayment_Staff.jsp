...
.center_div span{float:right;width:100%;background-color:#e0ffff;}
  ...
  <table width="100%"  border="1" cellpadding="0" cellspacing="0" class="table-ss" id="jqajax" >
      <tr id="title" class="title" style="background-color:#DEE3EF;" >
	        <td width="9%" align="center" style="font-family: 'Arial Narrow';font-size:14px; "><strong>Staff Code</strong></td>
	        <td width="12%" align="center" style="font-family: 'Arial Narrow';font-size:14px; "><strong>Principal</strong></td>
