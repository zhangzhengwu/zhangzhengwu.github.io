...
<div class="cont-info">
	<div class="info-title">
		<div class="title-info">
			<form action="AddStaffRequestConvoyServlet" id="myform" method="post">
			<table>
				<tr>
					<td class="tagName">Staff Code:</td>
					<td class="tagCont">
						<input id="StaffNo" name="StaffNos" readonly="readonly" value="${convoy_username}" onkeyup="this.value=this.value.toUpperCase();"  type="text" size="48" class="txt" />
						<span class="red">*</span>        
					</td>
				...
				<tr>
					...
					<td class="tagCont">
						<label class="inline radio">
							<input name="ETs" type="radio" value="Y" checked="checked"/>
							YES
						</label>
						<label class="inline radio">
					...
					<td class="tagCont">
        				...
        				<input name="urgentDate" id="urgentDate"   type="text" readonly="readonly" title="輸入日期最好大於當前日期" onclick="Calendar('urgentDate');"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tagCont" colspan="3">
						...
						<input id="pay" type="hidden" value="${convoy_username}" name="pays"/>
				...
				<tr>
					<td class="tagBtn" colspan="4">
						<input name="method" value="saverequestconvoy" type="hidden" />
