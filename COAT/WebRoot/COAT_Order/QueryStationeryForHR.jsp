...
/*****************************************************Down click**********************************/
	$("#down").click(function(){ 
		if(downs!=null){
			//window.location.href="../ReportStationeryServlet?start_Date="+$("#start_date").val()+"&end_Date="+$("#end_date").val()+"&curretPage="+curPage+"&staffcode="+$("#staffcodes").val();
			$.ajax({
				type: "post",
	...
	function selects(){
			...
			$.ajax({
			type: "post",
			url:"QueryStationeryRecordServlet",
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-ss">
            <tr>
              <td height="21" colspan="4" align="left"><div align="center" class="STYLE1">Query Stationery Order For HR<br>
              </div></td>
            </tr>
            <tr>
