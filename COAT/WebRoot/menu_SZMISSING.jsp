	...
	<ul id="menuUl">
		<li class="">
			<a class="" href="#" onclick="changeNav(this)">
				<i class="icon-list-alt"></i>Missing Payment
			</a>
			<ul class="nav-submenu">
				<li>
					<span data-url="namecard/MissingPayment_All.jsp">
						<i class="icon-caret-right"></i>Staff MPR
					</span>
				</li>
			</ul>
		</li>
		<li class="">
			<a class="" href="#" onclick="changeNav(this)">
				<i class="icon-list-alt"></i>Return Mail
			</a>
			<ul class="nav-submenu">
				<li>
					<span data-url="report/ReturnMailReport.jsp">
						<i class="icon-caret-right"></i>NB Report
					</span>
				</li>
				<li>
					<span data-url="report/ReturnMailReport2.jsp">
						<i class="icon-caret-right"></i>Return Mail Report
					</span>
				</li>
			</ul>
		</li>
