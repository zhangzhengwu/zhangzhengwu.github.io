...
<html>
  <head>
  	...
  	function select(pagenow){
  		$.ajax({
			...
			complete: function(){
  			...
  			data:{"method":"selectAutoChangeApply",
	  			...
	  			if(dataRole[3]>0){
	  				...
	  				for ( var i = 0; i < dataRole[0].length; i++) {
		  				html+="<tr class='tr_search'><td>"+(((pagenow-1)*15)+(i+1))
		  					 ...
		  					 +"</td><td>"+dataRole[0][i].seatnobefore
    ...
    function page(currt,total){
	  ...
	  function detail(i){
	  	      location.href="<%=basePath%>"+"SeatAutoServlet?method=detail&refno="+i;
	  }
  ...
  <div class="info-table">
  	...
  	<thead>
		<tr>
			...
			<th class="width_5">SeatNoBefore</th>
