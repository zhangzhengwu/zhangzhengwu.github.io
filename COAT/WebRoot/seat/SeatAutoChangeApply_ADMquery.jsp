...
<html>
  <head>
	 ...
	 var down = null;
  	...
  	function select(pagenow){
  		$.ajax({
  			...
  			data:{"method":"selectAutoChangeApplyForADM",
	  			...
	  			if(dataRole[3]>0){
	  				...
	  				for ( var i = 0; i < dataRole[0].length; i++) {
		  				html+="<tr class='tr_search'><td>"+(((pagenow-1)*15)+(i+1))
		  					 ...
		  					 +"</td><td>"+dataRole[0][i].leadercode
		  					 +"</td><td>"+dataRole[0][i].leadername
    ...
    function page(currt,total){
	  ...
	  function detail(i){
	  	      location.href="<%=basePath%>"+"SeatAutoServlet?method=detailForADM&refno="+i;
	  }
  ...
  <div class="info-search">
	<table>
		...
		<tr>
			...
			<td class="tagCont">
				<input type="text" name="leadercode" id="leadercode" />
			</td>
		...
		<tr>
			...
			<td class="tagCont">
				<select id="status">
	             	...
	             	<option value="Confirmed"> Confirmation Request</option>
  ...
  <div class="info-table">
  	...
  	<thead>
		<tr>
			...
			<th class="width_5">StaffName</th>
			<th class="width_5">SeatNo</th>
			<th class="width_5">LeaderCode</th>
			<th class="width_5">LeaderName</th>
