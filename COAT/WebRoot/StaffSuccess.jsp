...
-->
  ...
  setInterval("window.location.href='addStaffCard.jsp'",5000);//4秒后执行跳转（为了和数字相应）
  }
	  function changes(){
	num=num-1;
			 $("#num").val(num).html(num);
  ...
  <body ><center>
   <div id="Layer1" align="center">
    <table border="1" cellpadding="0" cellspacing="0"   bgcolor="#F3F3FA" class="table-ziz" style="top: 1px; height: 116px; left: 1px; width: 474px;">
      ...
      <tr>
        <td width="237" height="26" class="STYLE2"><a href="addStaffCard.jsp" >繼續插入數據</a></td>
        <td width="241" class="STYLE2"><a href="queryStaffCard.jsp">查詢數據</a></td>
      </tr>
    </table>
  </div></center>
  </body>
