...
public class Medical_Consultant {
	...
	public Medical_Consultant() {
	 
	}
	public Medical_Consultant(String staffcode, String name, String aDType,
			String sPType, String medicalDate, String medicalFee,
			String entitledFee, String termsYear, String medicalMonth,
			String medicalNormal, String medicalSpecial, String staffCodeDate,
			String sameDaye, String halfConsultant, String updName,
			String updDate, String sfyx, String resignDate, String md,
			String shzt, String addName, String addDate, String file,
			String remark) {
		super();
