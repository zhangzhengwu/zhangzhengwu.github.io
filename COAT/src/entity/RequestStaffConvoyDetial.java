...
public class RequestStaffConvoyDetial implements java.io.Serializable {
	...
	/** default constructor */
	public RequestStaffConvoyDetial() {
	}

	/** minimal constructor */
	public RequestStaffConvoyDetial(String username, Integer staffrefno,
			String staffcode) {
