...
public class RequestStaffConvoyBean {
	...
	private String remarkcons;
	private String shzt;//Y:审核通过,N:审核拒绝,S:待审核,E:一审(Dpt Approved),R:二审(HR Approved)
	...
	/**
	 * @param remarkcons the remarkcons to set
	 */
	public void setRemarkcons(String remarkcons) {
		this.remarkcons = remarkcons;
	}
	/**
	 * @return the remarkcons
	 */
	public String getRemarkcons() {
		return remarkcons;
	}
	/**
