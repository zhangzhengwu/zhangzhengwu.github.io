...
public class Medical_record_staff_bak {
	 private int id;
	...
	public Medical_record_staff_bak() {
	}
	...
	public Medical_record_staff_bak(String staffcode, String name,
			...
			String returnOraginal, String sameDay, String updName,
			String updDate, String sfyx, String subject, String remark) {
		super();
	...
	public Medical_record_staff_bak(int id, String staffcode, String name,
			String company, String dept, String grade, String plan,
			String packages, String email, String maxamount, String type,
			String term, String medicalNormal, String medicalSpecial,
			String medicalRegular, String medicalDental, String medicalDate,
