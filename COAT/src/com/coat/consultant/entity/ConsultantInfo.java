...
/**
 * Consultantinfo entity. @author MyEclipse Persistence Tools
 */

public class ConsultantInfo implements java.io.Serializable {
	...
	/** full constructor */
	public ConsultantInfo(String consultantId, String alias, String surName,
			...
			String ddtreeHead, String halfConsultant, String dateJoin) {
