...
public class C_Adminservice implements java.io.Serializable {
	...
	private String forgetExtenmsion;
 ...
 */
	public C_Adminservice(String refno, String staffcode, String staffname,
		...
		this.phoneNumber = phoneNumber;   //phone1
		this.phoneRpass = phoneRpass;
		this.phoneNumber2 = phoneNumber2; //phone2
	...
	public C_Adminservice(String refno, String staffcode, String staffname,
			...
			String description, String remark, String creator,
			String createDate, String status, String sfyx,String location
			,String seatNumber,String phonePas,String forgetExtenmsion,String phoneType) {
		super();
		this.refno = refno;
		this.staffcode = staffcode;
		this.staffname = staffname;
		...
		this.phonePas=phonePas;
		this.forgetExtenmsion=forgetExtenmsion;
	...
	public C_Adminservice(String refno, String staffcode, String staffname,String location,
			...
			String officeMaintenance, String floor3, String description,
			String remark, String creator, String createDate, String status,
			String sfyx,String seatNumber,String phonePas,String forgetExtenmsion,String phoneType) {
		super();
		this.refno = refno;
		this.staffcode = staffcode;
		this.staffname = staffname;
	...
	public String getPhonePas() {
		return phonePas;
	}



	public void setPhonePas(String phonePas) {
		this.phonePas = phonePas;
	}



	public String getForgetExtenmsion() {
		return forgetExtenmsion;
	}



	public void setForgetExtenmsion(String forgetExtenmsion) {
		this.forgetExtenmsion = forgetExtenmsion;
	}
