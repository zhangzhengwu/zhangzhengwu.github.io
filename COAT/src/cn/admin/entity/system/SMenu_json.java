...
public class SMenu_json {
	...
	/** minimal constructor */
	public SMenu_json(Integer menuid) {
		this.menuid = menuid;
	}
	 ...
	 * @param sfyx
	 */
	public SMenu_json(Integer menuid, String menuname, String menuAction,
			Integer parentId, String parentName, Integer childshort,
			Integer parentshort, String remark, String createname,
