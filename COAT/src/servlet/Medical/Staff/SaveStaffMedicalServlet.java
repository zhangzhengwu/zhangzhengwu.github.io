...
public class SaveStaffMedicalServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	 ...
	 //保存
		...
		Medical_record_staff mrs=new Medical_record_staff(staffcode,staffname, company, dept, grade, pplan, packages,email, amount,type, term, 
				medicalNormal, medicalSpecial,Oral_Number,Dental_Number,MedicalDate, MedicalFee,DateUtils.strChToUs(DateUtils.getNowDateTime()), entitle, return_oraginal,SameDay, UserName, DateUtils.getNowDateTime(),"","", "Y"); 
			...
			e.printStackTrace();
			log.error("在SaveStaffMedicalServlet中保存staffMedical时出现："+e.toString());
