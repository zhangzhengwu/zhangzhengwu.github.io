...
public class AdminServiceServlet extends HttpServlet {
	...
	Logger log=Logger.getLogger(AdminServiceServlet.class);
	...
	private void complete(HttpServletRequest request, HttpServletResponse response){
		...
		com.coat.admservices.dao.AdminServiceDao adminServiceDao=new com.coat.admservices.dao.impl.AdminServiceDaoImpl();
		try{
	...
	private void down(HttpServletRequest request, HttpServletResponse response) {
		...
		try{
			...
			expcard.cteateTWOTitleCell(wb,row2,(short)3,"Ext.No");
			expcard.cteateTWOTitleCell(wb,row2,(short)4,"Remarks");
			expcard.cteateTWOTitleCell(wb,row2,(short)5,"Status");
			expcard.cteateTWOTitleCell(wb,row2,(short)6,"Time");
			
			
			HSSFSheet sheet3 = wb.createSheet("Desk Phone Reset Password");
			...
			for(int i=0;i<list.size();i++){
				...
				if(adminservice.getPhoneRepair().equals("Y")){
					HSSFRow row6=sheet2.createRow(i+1);
					expcard.cteateTitleCell(wb,row6,(short)0,adminservice.getRefno());
					expcard.cteateTitleCell(wb,row6,(short)1,adminservice.getStaffcode());
					expcard.cteateTitleCell(wb,row6,(short)2,adminservice.getStaffname());
					expcard.cteateTitleCell(wb,row6,(short)3,adminservice.getPhoneNumber());
				...
				if(adminservice.getPhoneRpass().equals("Y")){
					HSSFRow row6=sheet3.createRow(i+1);
					expcard.cteateTitleCell(wb,row6,(short)0,adminservice.getRefno());
					expcard.cteateTitleCell(wb,row6,(short)1,adminservice.getStaffcode());
					expcard.cteateTitleCell(wb,row6,(short)2,adminservice.getStaffname());
				...
				if(adminservice.getCopierRepair().equals("Y")){
					HSSFRow row6=sheet4.createRow(i+1);
					expcard.cteateTitleCell(wb,row6,(short)0,adminservice.getRefno());
					expcard.cteateTitleCell(wb,row6,(short)1,adminservice.getStaffcode());
					expcard.cteateTitleCell(wb,row6,(short)2,adminservice.getStaffname());
				...
				if(adminservice.getOfficeMaintenance().equals("Y")){
					HSSFRow row6=sheet5.createRow(i+1);
					expcard.cteateTitleCell(wb,row6,(short)0,adminservice.getRefno());
					expcard.cteateTitleCell(wb,row6,(short)1,adminservice.getStaffcode());
					expcard.cteateTitleCell(wb,row6,(short)2,adminservice.getStaffname());
