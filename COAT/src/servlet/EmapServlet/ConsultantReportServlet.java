...
public class ConsultantReportServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger log=Logger.getLogger(ConsultantReportServlet.class);
	...
	throws ServletException, IOException {
		try{
			...
			e.printStackTrace();
			log.error("查询 Consultant Emap 时出现："+e.toString());
		}
